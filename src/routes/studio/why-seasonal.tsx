...
export const Route = createFileRoute("/studio/why-seasonal")({
  component: WhySeasonalRoute,
});

function WhySeasonalRoute() {
  return (
    <StudioPageLayout
      title="Why Seasonal"
    ...
    >
      <StudioLayout
        title="The Studio ▾ Why Seasonal"
        className="why-seasonal-page"
        wrapperClassName="why-seasonal-wrapper"
        containerClassName="why-seasonal-container"
      >
        <AtmosphericBanner
