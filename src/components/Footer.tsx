...
export const socialLinks: SocialLink[] = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/pages/creation/?profile_switcher_unified_creation=321587362&ref_type=profile_switcher_unified_creation',
  ...
  {
    name: 'Tumblr',
    href: 'https://www.tumblr.com/sjkmomentscaptured?source=share',
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/so_retro_draw/',
    ...
    <div className={className}>
      {socialLinks.map((link) => (
        <a
          ...
          style={{ '--icon-tint': link.brandTint } as CSSProperties}
        >
          {link.icon}
        </a>
      ))}
